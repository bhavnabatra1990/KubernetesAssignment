...
namespace NAGPAssignment
{
    public static class Registration
    {
        ...
        public static IServiceCollection RegisterService(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            string connString = $"Server=tcp:mssql-0.mssql-db.applicationnamespace.svc.cluster.local,1433;Initial Catalog=EmployeeDb;User Id=sa;Password=Welcome@0001234567;Trusted_Connection=True;TrustServerCertificate=True;Integrated Security=false";
